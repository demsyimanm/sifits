	...
	function test(x)
	{
		...
		if (x.children[x.selectedIndex].innerHTML == "Per Tahun")
		{
			...
			if ($('#jenisTahun').length == 0)
			{
			    ...
			    var button = $(document.createElement('a')).html('Lihat').addClass('btn btn-primary btn-block').attr({type:"submit", style:"width:150px;position:fixed;", href:"penyewaan.php"});
